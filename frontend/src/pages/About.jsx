  ...
  return (
    <div>
      ...
      <div className='aboutContainer'>
        ...
        <img src={aboutBurger} alt='burger' className='aboutMainBurger' loading='lazy'/>
    ...
    <img src={aboutBurgerOne} alt='burger being cooked' className='cookedBurgerImg' loading='lazy'/>
